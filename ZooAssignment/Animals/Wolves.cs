...
namespace ZooAssignment
{
    public class Wolves : Animal
    {
        ...
        public Wolves(string name, string nickname, int age, double weight, int walterNumber, DateTime dateTime) : base(name, nickname, age, weight, walterNumber, dateTime)
        {
        }
